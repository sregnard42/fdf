...
/*   Updated: 2018/12/18 14:01:26 by sregnard         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				main(int ac, char **av)
{
	...
	params->win = mlx_new_window(params->mlx, params->win_size->x, params->win_size->y, "FdF");
	mlx_key_hook(params->win, &get_input, params);
	img = mlx_xpm_to_image(params->mlx, params->xpm->map, &(params->xpm->width), &(params->xpm->height));
